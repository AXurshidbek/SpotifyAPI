    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('albom', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='musiqa.albom')),
            ],
        ),
        migrations.AddField(
            model_name='albom',
            name='qoshiqchi',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='musiqa.qoshiqchi'),
        ),
    ]
